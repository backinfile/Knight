...
import com.backinfile.game.net.Connection;
...
public class Player {
	...
	public void operChooseOne(Set<Card> cards, boolean canIgnore, String tip, Consumer<Card> callBack) {
		// TODO
	}

	public void operChooseBattlePos(Set<Integer> poses, boolean canIgnore, String tip, Consumer<Card> callBack) {
		// TODO
	}
